...
void gameWon(MaxMatrix *matrixWinningPlayer, MaxMatrix *matrixLosingPlayer) {
  ...
  matrixWinningPlayer->writeSprite(0, 0, W);
  matrixLosingPlayer->writeSprite(0, 0, L);
  delay(500);
  matrixWinningPlayer->clear();
  matrixLosingPlayer->clear();
  matrixWinningPlayer->writeSprite(0, 0, I);
  matrixLosingPlayer->writeSprite(0, 0, O);
  delay(500);
  matrixWinningPlayer->clear();
  matrixLosingPlayer->clear();
  matrixWinningPlayer->writeSprite(0, 0, N);
  matrixLosingPlayer->writeSprite(0, 0, S);
  delay(500);
  matrixWinningPlayer->clear();
  matrixLosingPlayer->clear();
  matrixWinningPlayer->writeSprite(0, 0, N);
  matrixLosingPlayer->writeSprite(0, 0, E);
  delay(500);
  matrixWinningPlayer->clear();
  matrixLosingPlayer->clear();
  matrixWinningPlayer->writeSprite(0, 0, E);
  matrixLosingPlayer->writeSprite(0, 0, R);
  delay(500);
  matrixWinningPlayer->clear();
  matrixWinningPlayer->writeSprite(0, 0, R);
  delay(500);
}
